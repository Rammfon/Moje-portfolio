...
export const Skills = () => (
  <div id="skills" class="pl-6 pr-4 pb-5 pt-5">
    <h1>Moje služby</h1>
    <p>
      Jak už název webu napovídá, jsem copywriter a mohu vám tudíž nabídnout{" "}
      <strong>copywriting</strong> (to jste nečekali, že?).
    </p>{" "}
    <p>
      {" "}
      Konkrétně:
