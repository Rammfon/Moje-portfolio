...
export const About = () => (
  <div id="about">
    ...
    <p>
      ...
      mimozemského původu. Proto si ostatně často připadám jako ufon. Jak už
      jste si mohli všimnout, mám osobitý (zní to lépe, než blbý) smysl pro
      humor, příliš bujarou fantazii a poměrně široký okruh zájmů. Jeden můj
